<%-- 
    Document   : rarocFacility
    Created on : Aug 16, 2014, 3:39:36 AM
    Author     : vinoy
--%>
        ...
        <table class="datagrid">            
            ...
            <tbody>                                    
                ...
                <tr>            
                    ...
                    <c:forEach begin="1" end="${facCount}" var="object" varStatus="status">                    
                    <td class="middle">
                        <form:input cssClass="raroc validate[custom[number],min[0],max[100]]" path="facilities[${status.count-1}].avgUtil" value="${utilization}"/>
                    </td>
                    </c:forEach>
                </tr>
                <tr>            
                ...
                <tr>            
                    ...
                    <c:forEach begin="1" end="${facCount}" var="object" varStatus="status">                    
                    <td class="middle">
                       <form:input cssClass="raroc validate[custom[number]]" value="0" path="facilities[${status.count-1}].aFee"/>
                    </td>
                    </c:forEach>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <c:forEach begin="1" end="${facCount}" var="object" varStatus="status">                    
                        <td class="middle">
                            <form:input cssClass="raroc validate[custom[number],min[0],max[100]]" path="facilities[${status.count-1}].eGuar" value="${guarantee}"/>
                        </td>
                    </c:forEach>
                </tr>
                <tr>            
            ...
            <div class="ui-widget-content ui-corner-bottom">
                <table class="formTable">
                    <tr>                        
                        ...
                        <td class="field">
                            <form:input cssClass="uniform validate[custom[number]]" path="bbcdab" value="0"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="forlabel">
                        ...
                        <td class="field">
                            <form:input cssClass="uniform validate[custom[number]]" path="tdfee" value="0"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="forlabel">
                        ...
                        <td class="field">
                            <form:input cssClass="uniform validate[custom[number]]" path="bbfee" value="0"/>
                        </td>
                    </tr>          
                    <tr>
                        <td class="forlabel">
                        ...
                        <td class="field">
                            <form:input cssClass="uniform validate[custom[number]]" path="trsry" value="0"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="forlabel">
                        ...
                        <td class="field">
                            <form:input cssClass="uniform validate[custom[number]]" path="other" value="0"/>
                        </td>
                    </tr>
                </table>
            </div>
