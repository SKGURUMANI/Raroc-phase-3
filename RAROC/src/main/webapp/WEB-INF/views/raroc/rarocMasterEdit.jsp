                ...
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            ...
                            <div id="rids">
                                <input type="text" class="typeahead form-control" style="width: 385px;" name="rid" placeholder="Search..."  id="ratingId" aria-describedby="search" value="${ratingIds}" readonly="true"/>
                            </div>
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            ...
                            <form:input type="text" cssClass="form-control" path="pan" id="panNums" readonly="true"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass="form-control" path="cid" id="cid" readonly="true"/>
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass="form-control" path="rtool" id="rtoolnpt" readonly="true"/>
                            <form:select items="${rtool}" itemLabel="value" itemValue="key" cssClass=" form-control" id="rtoolSel" path="rtool">
                            </form:select>
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass="form-control" path="bussunit" readonly="true" id="bussunitInpt"/>
                            <form:select items="${bu}" itemLabel="value" itemValue="key" cssClass=" form-control" path="bussunit" id="bussunitSel">
                            </form:select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:select cssClass="form-control" path="expBanks">
                                <form:option value="" label="Select...."/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" path="portion"/>
                        </div>
                    </div>
                    <br/><br/><br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" path="nonFinColl"/>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass="form-control" path="cname" readonly="true" id="cname"/>
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" readonly="true" path="cif" id="cif"/>
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:select cssClass="form-control" path="intRat" id="intRateSel"></form:select>
                            <form:input type="text" cssClass=" form-control" readonly="true" path="intRat" id="intRatText"/>
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" readonly="true" path="ind" id="indText"/>
                            <form:select items="${ind}" itemLabel="value" itemValue="key" id="indSel" cssClass=" form-control" path="ind">
                            </form:select>
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" readonly="true" path="cpsid" id="cpsid"/>
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" path="ufce"/>
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass="form-control" path="npll"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:select cssClass=" form-control" path="workcap">
                                <form:option value="" label="Select...."/>
                                <form:option value="Yes" label="Yes"/>
                                <form:option value="No" label="No"/>
                            </form:select>
            ...
            <div class="panel-body no-gutters">
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" path="bbcdab" />
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" path="tdfee" />
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" path="forex" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" path="cafee" />
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" path="cms" />
                        </div>
                    </div>
                    <br/><br/>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <form:input type="text" cssClass=" form-control" path="other" />
                        </div>
                    </div>
                </div>
            </div>
